...
if(isset($_SESSION["Kullanici"])){
	...
	if($GelenID!=""){
		...
		$res= mysqli_query($link, "SELECT * FROM adresler WHERE id = '$GelenID' AND UyeId ='$KullaniciID'");
		$res1=mysqli_num_rows($res);
		$KayitBilgisi = mysqli_fetch_array($res, MYSQLI_ASSOC);
					...
					<td width="500" valign="top">
						<form action="index.php?SK=63&ID=<?php echo $GelenID; ?>" method="post">
							<table width="500" align="center" border="0" cellpadding="0" cellspacing="0">
								...
								<tr height="30">
									<td valign="top" align="left"><input type="text" name="Isim" class="InputAlanlari" value="<?php echo $KayitBilgisi["Isim"]; ?>"></td>
								</tr>
								<tr height="30">
									<td valign="bottom" align="left">Soyisim (*)</td>
								</tr>
								<tr height="30">
									<td valign="top" align="left"><input type="text" name="Soyisim" class="InputAlanlari" value="<?php echo $KayitBilgisi["Soyisim"]; ?>"></td>
								</tr>
								<tr height="30">
