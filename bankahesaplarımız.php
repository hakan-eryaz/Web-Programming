	...
	<tr>
		<td><table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr><?php
				...
				$PR_sql = $link->query("SELECT * FROM bankahesaplarimiz ORDER BY id asc");

				$DonguSayisi			=	1;
				$SutunAdetSayisi		=	3;
				
				while($Kayit = $PR_sql->fetch_assoc()){
				?>
					<td width="348">
						<table align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #CCCCCC; margin-bottom: 10px;">
							<tr height="40">
								<td colspan="4" align="center"><img style="height:100px;" src="images/cart/<?php echo DonusumleriGeriDondur($Kayit["BankaLogosu"]); ?>" border="0"></td>
							</tr>
							<tr height="25">
								<td width="5">&nbsp;</td>
