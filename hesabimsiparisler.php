...
// $ToplamKayitSayisiSorgusu				=	$VeritabaniBaglantisi->prepare("SELECT DISTINCT SiparisNumarasi FROM siparisler WHERE UyeId = '$KullaniciID' ORDER BY SiparisNumarasi DESC");
// $ToplamKayitSayisiSorgusu->execute([$KullaniciID]);
// $ToplamKayitSayisiSorgusu				=	$ToplamKayitSayisiSorgusu->rowCount();
$ToplamKayitSayisiSorgusu="SELECT DISTINCT SiparisNumarasi FROM siparisler WHERE UyeId = '$KullaniciID' ORDER BY SiparisNumarasi DESC";
$result= mysqli_query($link,$siparişsorgu);
$resultsayisi=mysqli_num_rows($ToplamKayitSayisiSorgusu);
	...
	<tr>
		<td width="1065" valign="top">
			<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
				...
				$siparişsorgu="SELECT * FROM siparisler WHERE UyeId = '$KullaniciID' ORDER BY id DESC";
				$result= mysqli_query($link,$siparişsorgu);
